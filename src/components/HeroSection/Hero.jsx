                ...
                <div className="banner-one-main-wrapper">
                    <div className="row">
                        ...
                        <div className="col-lg-7 order-lg-1 padding">
                            <div
                                className="tmp-scroll-trigger tmp-fade-in animation-order-1 google-rating-badge style1"
                            ...
                            >
                                ...
                                <div
                                    className="rating-divider svg_image13"
                                ...
                                <div className="svg_image14">
                                    ...
                                    <span
                                        className="reviews-text svg_image18"
                            ...
                            <div className="inner">
                                ...
                                <p className="disc tmp-scroll-trigger tmp-fade-in animation-order-3 svg_image19">
                                    Thank you for visiting my website. I have been a dedicated mobile app developer in Dubai since 2006 and have collaborated with some of the UAE's top brands, including Dubai Tourism, Atlantis, and Hamdan Sports Complex.
                                </p>
