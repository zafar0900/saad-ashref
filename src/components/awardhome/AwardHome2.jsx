...
export default function AwardHome() {
  ...
  const current = experiences[displayed];
  ...
  const contentClass =
    phase === "exit"
      ? "aw-content-wrap aw-content--exit"
      : phase === "enter"
      ? "aw-content-wrap aw-content--enter"
      : "aw-content-wrap";
  ...
  return (
    <section className="aw-section">
      ...
      <style jsx>{`
        ...
        .aw-content--exit {
          animation: awSlideToLeft 0.26s cubic-bezier(0.55, 0, 1, 0.45) both;
        }
        .aw-content--enter {
          animation: awSlideFromLeft 0.75s cubic-bezier(0.25, 0.46, 0.45, 0.94) both;
        }

        @keyframes awSlideToLeft {
          from { opacity: 1; transform: translateX(0); }
          to   { opacity: 0; transform: translateX(-55px); }
        }
        @keyframes awSlideFromLeft {
